                        ...
                        const PATH: &str = ::const_format::pmr::__AssertStr {
                            x: {
                                const ARGS_OSRCTFL4A: ::const_format::__str_methods::ReplaceInput = ::const_format::__str_methods::ReplaceInputConv(
                                        "/home/sert/Documents/local/github_projects/SimpleAI/packages/macros/tests/element/entry.rs",
                                        "\\\\",
                                        "/",
                                    )
                                    .conv();
...
#[allow(unused)]
pub use TestEntry_completions::Component::TestEntry;
