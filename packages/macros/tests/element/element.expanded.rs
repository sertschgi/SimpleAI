                        ...
                        const PATH: &str = ::const_format::pmr::__AssertStr {
                            x: {
                                const ARGS_OSRCTFL4A: ::const_format::__str_methods::ReplaceInput = ::const_format::__str_methods::ReplaceInputConv(
                                        "/home/sert/Documents/local/github_projects/SimpleAI/packages/macros/tests/element/element.rs",
                                        "\\\\",
                                        "/",
                                    )
                                    .conv();
...
#[allow(non_snake_case)]
#[doc(hidden)]
mod TestElementEntry_completions {
    #[doc(hidden)]
...
#[allow(unused)]
pub use TestElementEntry_completions::Component::TestElementEntry;
#[allow(non_snake_case)]
...
#[allow(non_snake_case)]
#[doc(hidden)]
mod TestElementPage_completions {
    #[doc(hidden)]
    #[allow(non_camel_case_types)]
    /// This enum is generated to help autocomplete the braces after the component. It does nothing
    pub enum Component {
...
#[allow(unused)]
pub use TestElementPage_completions::Component::TestElementPage;
